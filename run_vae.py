...
projection.to_csv('files/res/patno_archetype_runid='+str(run_id)+'.csv')
"""
#-----------------------------------------------------------------------------
...
#==================================================================================================================
run_id = 99
patno_cluster_2 = pd.read_csv("files/res/02_patno_type_cluster_runid="+str(run_id)+".csv", index_col=0)
run_id = 154
patno_cluster_5 = pd.read_csv("files/res/02_patno_type_cluster_runid="+str(run_id)+".csv", index_col=0)
def compute_confusion_matrix(patno_cluster_2, patno_cluster_5):
    ...
    plt.title('Cluster intersection (pat,prot) = ('+ str(n_participant)+','+str(nb_proteins)+')')
    plt.margins(x=0.1, y=0.1)
